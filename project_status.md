...
| 4 | **Tự động sinh bộ Lịch bảo dưỡng mẫu khi tạo Xe** | Vừa thêm xe mới (với km hiện tại và ngày mua) là hệ thống tự động khởi tạo sẵn trọn bộ lịch nhắc thay nhớt 5.000km, 10.000km, đăng kiểm định kỳ. | 🔴 Chưa thực hiện (Đang yêu cầu chọn/tạo thủ công) |
